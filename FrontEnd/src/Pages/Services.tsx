        ...
        <div className="w-full min-h-screen px-4 sm:px-6 lg:px-8 py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Standard Plan */}
                    <div className="bg-gradient-to-br from-slate-800 to-blue-600 rounded-2xl shadow-lg overflow-hidden text-white transform hover:scale-105 transition-all flex flex-col min-h-[700px]">
                        <div className="p-8 flex-grow">
                            <div>
                                <h3 className="text-2xl font-bold mb-2">Standard Plan</h3>
                                <p className="text-gray-100 mb-6 h-12">For Passionate Readers!</p>
                            ...
                            <div className="border-t border-white/20 pt-6">
                                ...
                                <p className="text-gray-100 mb-6">Plus, you'll receive priority registration for events.</p>
                        ...
                        <div className="p-8 pt-0">
                            <Link
                                to="/register"
                                className="block w-full text-center px-6 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-colors font-medium"
                            >
                                Select Plan
                            </Link>
                        </div>
                    ...
                    {/* Premium Plan */}
                    <div className="bg-gradient-to-br from-slate-800 to-purple-600 rounded-2xl shadow-lg overflow-hidden text-white transform hover:scale-105 transition-all flex flex-col min-h-[700px]">
                        <div className="p-8 flex-grow">
                            <div>
                                <h3 className="text-2xl font-bold mb-2">Premium Plan</h3>
                                <p className="text-gray-100 mb-6 h-12">Read Together, Grow Together!</p>
                                <div className="flex items-baseline mb-8">
                            ...
                            <div className="mt-4">
                                <div className="flex items-baseline mb-4">
                                    <span className="text-2xl font-bold">1199.99</span>
                                    <span className="ml-2">EGP</span>
                                    <span className="ml-2">Annual</span>
                                </div>
                            </div>
                    ...
                    {/* Family Plan */}
                    <div className="bg-gradient-to-br from-slate-800 to-emerald-600 rounded-2xl shadow-lg overflow-hidden text-white transform hover:scale-105 transition-all flex flex-col min-h-[700px]">
                        <div className="p-8 flex-grow">
                            <div>
